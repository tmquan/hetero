...
int main(int argc, char** argv)
{
	...
	checkWriteFile("hSub.bin", h_C, total*sizeof(float2));
	////////////////////////////////////////////////////////////////////////////////////////////////////
	//GPU subition
	...
	timer.Start();
	sub(d_A, d_B, d_C, dimx, dimy, dimz);
	timer.Stop();
	
	printf("Substraction: %4.4f ms\n", timer.Elapsed());
	
	cudaMemcpy(h_D, d_C, total*sizeof(float2), cudaMemcpyDeviceToHost);

	checkWriteFile("dSub.bin", h_D, total*sizeof(float2));
	////////////////////////////////////////////////////////////////////////////////////////////////////
	return 0;
}